...
import { useMe } from '../hooks/useMe'; // useMe 훅을 임포트합니다.
...
function AppLayout() {
    ...
    return (
        <Box sx={{ minHeight: '100vh', bgcolor: '#cdffe9ff' }}>
            {/* header */}
            <Box component="header" sx={{
                ...
                zIndex: 10,
                bgcolor: '#77a1f5ff',
                borderBottom: '1px soild #f5ffcdff',
                width: '100%'
            }}>
                <Container maxWidth="lg" sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: 60, }}>
                    <Box component={Link} to="/posts"
                        ...
                        <Box sx={{
                            ...
                            <BiSolidBug style={{ color: '#5A9CB5', fontSize: 22, }} />
                        </Box>
                        <Typography variant='h6' sx={{ fontWeight: 700, color: '#654' }}>
                            게시판
                        </Typography>
                    </Box>
